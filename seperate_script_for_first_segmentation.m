...
% loose the addtional info about the "location" of the entities
% probably faster with regex
...
EEG = pop_epoch( EEG, Relevant_Markers , [-1 5], 'newname', strcat(filenames{VP},'_intchan_avg_filt epochs'), 'epochinfo', 'yes'); %selection: -1 to 8 seconds
